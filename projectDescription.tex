...
We also intend to implement the model checking for the logic $reg\text{-}\mathcal{L}^U_{Kh}$ defined in \cite{Demri2023}.
...
\begin{itemize}
    ...
    \item Implement the explicit model checker for the basic knowing how logic;
    \item Implement model checking problem for the logic $reg\text{-}\mathcal{L}^U_{Kh}$ defined in \cite{Demri2023};
